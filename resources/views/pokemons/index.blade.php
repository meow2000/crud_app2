	...
	<div class="table-responsive">
		<div class="table-wrapper">
			<div class="table-title">
				<div class="row">
					<div class="col-sm-6">
						<h2 id='test'>Manage <b>Pokemon</b></h2>
					</div>
				
					<div class="col-sm-6">
						<a href="#addEmployeeModal" class="btn btn-success" data-toggle="modal"><i class="material-icons">&#xE147;</i> <span>Add New Pokemon</span></a>
		...
		<div class="modal-content">
			<form method ="POST" action='/pokemons'>
				...
				<div class="modal-header">						
					<h4 class="modal-title">Add Pokemon</h4>
